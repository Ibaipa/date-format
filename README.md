...
Documento vivo del modelo de fechas para Entertainment XD. Abrir `date-format.html` en navegador.

## Estructura

```
docs/
├── date-format.html      # documento principal — abrir en navegador
├── img/                # capturas de pantalla referenciadas por date-format.html
...
En `date-format.html`, dentro de `<section id="casos">`, copiar un bloque `<div class="case">` y editar:
